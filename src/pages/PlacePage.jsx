                        ...
                        <div className='flex md:flex-row flex-col gap-3'>
                            ...
                            <div className='py-2 md:px-4 px-1 rounded-2xl border shadow-lg'>
                                ...
                                <form action="" onSubmit={handleSubmit}>
                                    ...
                                    <input type='submit' disabled={activePlace.status === 'Booked'} value={`${activePlace.status === 'Booked'?'Not Available':`${bookingLoading?'Booking...':'Book'}`}`} className={`w-full py-2 bg-red-500 text-white font-semibold mt-3 rounded-full ${bookingLoading?'bg-opacity-50 cursor-default':''}  ${activePlace.status === 'Booked'?'cursor-default bg-opacity-50 ':'cursor-pointer'}`} />
                                </form>
